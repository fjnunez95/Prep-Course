...
function dePalabrasAFrase(palabras) {
  ...
  return conespacios;*/ // esta es una manera pero debes hacerlo aplicando lo aprendido
  // Tu código:
  var frase = "";
...
function numeroMasGrande(numeros) {
  ...
  return max;*/ // esta es una manera de hacerla, ahora usa lo aprendido para resolverlo.
  // Tu código:
  var nummasgrande = 0;
